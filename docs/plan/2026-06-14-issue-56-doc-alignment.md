...
| README language cleanup | completed | Replaced the remaining Korean README guidance with English wording without changing meaning. | `rg -n "[가-힣]" README.md` returned no matches |
